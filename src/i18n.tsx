...
const en = {
  ...
  settings: {
    ...
    localPreviewFolder: 'Local PDF preview folder', localPreviewFolderHelp: 'Choose a folder on this device to preview matching PDFs. Files stay in your browser and are not uploaded.', chooseLocalPreviewFolder: 'Choose local folder', localPreviewNone: 'No local folder selected', localPreviewSelected: '{count} PDFs ready for preview',
...
const ja: Dict = {
  ...
  settings: {
    ...
    localPreviewFolder: 'ローカルPDFプレビューフォルダ', localPreviewFolderHelp: 'この端末上のフォルダを選ぶと、該当するPDFをプレビューできます。ファイルはブラウザ内に留まり、アップロードされません。', chooseLocalPreviewFolder: 'ローカルフォルダを選択', localPreviewNone: 'ローカルフォルダが未選択です', localPreviewSelected: '{count}件のPDFをプレビュー可能',
